        ...
        if (student != null) {
            if (!isDuplicateCheckIn(student)) {
                ...
                checkInLog.add(new String[]{
                        "\u001B[31m" + new SimpleDateFormat("dd.MM.yyyy-HH:mm:ss").format(new Date(student.lastCheckIn)) + "\u001B[0m",
                        "\u001B[31m" + student.cardPin + "\u001B[0m",
                        "\u001B[31m" + student.firstName + "\u001B[0m",
                        "\u001B[31m" + student.lastName + "\u001B[0m",
                        "\u001B[31m" + student.classNumber + "\u001B[0m",
                        "\u001B[31m" + student.schoolDiaryNumber + "\u001B[0m"
                });
                ...
                System.out.println("\u001B[31mWarning: " + student.firstName + " " + student.lastName
                        + " already checked in within the last 2 hours.\u001B[0m");
            }
        } else {
